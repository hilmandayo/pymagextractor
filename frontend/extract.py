...
#
# Created: Tue Nov 27 14:24:10 2018
...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.extractor_box = QtWidgets.QGroupBox(self.centralwidget)
        self.extractor_box.setGeometry(QtCore.QRect(10, 10, 931, 521))
        self.extractor_box.setObjectName("extractor_box")
        self.original_box = QtWidgets.QGroupBox(self.extractor_box)
        self.original_box.setGeometry(QtCore.QRect(10, 30, 450, 350))
        self.original_box.setObjectName("original_box")
        self.original_video = QtWidgets.QLabel(self.original_box)
        self.original_video.setGeometry(QtCore.QRect(0, 20, 440, 330))
        self.original_video.setAlignment(QtCore.Qt.AlignCenter)
        self.original_video.setObjectName("original_video")
        self.refined_box = QtWidgets.QGroupBox(self.extractor_box)
        self.refined_box.setGeometry(QtCore.QRect(470, 30, 450, 350))
        self.refined_box.setObjectName("refined_box")
        self.play_bnt = QtWidgets.QPushButton(self.extractor_box)
        self.play_bnt.setGeometry(QtCore.QRect(430, 480, 80, 25))
        self.play_bnt.setFocusPolicy(QtCore.Qt.NoFocus)
        self.play_bnt.setText("")
        self.play_bnt.setObjectName("play_bnt")
        self.previous_bnt = QtWidgets.QPushButton(self.extractor_box)
        self.previous_bnt.setGeometry(QtCore.QRect(330, 480, 80, 25))
        self.previous_bnt.setFocusPolicy(QtCore.Qt.NoFocus)
        self.previous_bnt.setObjectName("previous_bnt")
        self.next_bnt = QtWidgets.QPushButton(self.extractor_box)
        self.next_bnt.setGeometry(QtCore.QRect(530, 480, 80, 25))
        self.next_bnt.setFocusPolicy(QtCore.Qt.NoFocus)
        self.next_bnt.setObjectName("next_bnt")
        self.slider = QtWidgets.QSlider(self.extractor_box)
        self.slider.setGeometry(QtCore.QRect(19, 450, 901, 20))
        self.slider.setFocusPolicy(QtCore.Qt.NoFocus)
        self.slider.setOrientation(QtCore.Qt.Horizontal)
        self.slider.setObjectName("slider")
        self.frames_label = QtWidgets.QLabel(self.extractor_box)
        self.frames_label.setGeometry(QtCore.QRect(300, 420, 331, 20))
        self.frames_label.setAlignment(QtCore.Qt.AlignCenter)
        self.frames_label.setObjectName("frames_label")
        self.objects_label = QtWidgets.QLabel(self.extractor_box)
        self.objects_label.setGeometry(QtCore.QRect(310, 390, 311, 17))
